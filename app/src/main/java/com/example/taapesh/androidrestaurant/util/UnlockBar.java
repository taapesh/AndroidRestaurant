...
public class UnlockBar extends RelativeLayout
{
    ...
    private RelativeLayout img_thumb = null;
    ...
    private int initialTextPadding = 0;
    ...
    public void hideLabel() {
        text_label.setVisibility(INVISIBLE);
    }
    public void showLabel() {
        text_label.setVisibility(VISIBLE);
    }
    ...
    public void reset()
    {
        ...
        text_label.setPadding(initialTextPadding, 0, 0, 0);
    }
    ...
    private void init(Context context, AttributeSet attrs)
    {
        ...
        img_thumb = (RelativeLayout) findViewById(R.id.img_thumb);

        // Get padding
        thumbWidth = dpToPx(120); // 60dp + 2*10dp
        initialTextPadding = dpToPx(140);
        text_label.setPadding(initialTextPadding, 0, 0, 0);
    }
    ...
    public boolean onTouchEvent(MotionEvent event)
    {
        ...
        else if (event.getAction() == MotionEvent.ACTION_MOVE && sliding)
        {
            ...
            else
            {
                ...
                int progress = (int) (sliderPosition * 100 / (max * 1.0f)); // Calculate progress
                text_label.setAlpha(1f - progress * 0.02f); // Fade out text label
                text_label.setPadding(initialTextPadding + 5 * progress, 0, 0, 0); // Move text label right
            }
